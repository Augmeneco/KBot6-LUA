return function(msg)
    param = {v='5.90',q=urlencode.encode_url(msg.user_text),count=0,access_token=msg.config.user_token}
    ...
    param = {v='5.90',q=urlencode.encode_url(msg.user_text),offset=math.random(0,count),count=10,access_token=msg.config.user_token}
